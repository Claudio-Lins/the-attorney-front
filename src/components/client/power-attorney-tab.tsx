        ...
        return (
            <div className="w-full h-28 flex flex-col items-center justify-center gap-2 p-2 border rounded-md bg-green-50">
                ...
                <div className="flex gap-2 mt-1">
                    <Button size="sm" variant="outline" onClick={() => handleAction('open')}><Eye className="w-4 h-4 mr-1"/>Abrir</Button>
                    <Button size="sm" variant="outline" onClick={() => handleAction('download')}><Download className="w-4 h-4 mr-1"/>Baixar</Button>
                </div>
            </div>
        );
    }
